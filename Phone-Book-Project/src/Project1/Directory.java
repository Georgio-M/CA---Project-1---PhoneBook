...
public class Directory {
    ...
    public Contact[] getByFirstName(String first){
        int counter = 0;
        for(int i = 0; i < contacts.length; i++){
            if(contacts[i].getFirstName().toLowerCase().equals(first.toLowerCase())){
                counter++;
            }
        }
        ...
        for(int j = 0; j < contacts.length; j++){
            if(contacts[j].getFirstName().toLowerCase().equals(first.toLowerCase())){
    ...
    public Contact[] getByLastName(String last){
        int counter = 0;
        for(int i = 0; i < contacts.length; i++){
            if(contacts[i].getLastName().toLowerCase().equals(last.toLowerCase())){
                counter++;
            }
        }
        Contact[] newArray = new Contact[counter];
        int x = 0;
        for(int j = 0; j < contacts.length; j++){
            if(contacts[j].getLastName().toLowerCase().equals(last.toLowerCase())){
                newArray[x] = contacts[j];
                x++;
            }
        }
